...
import (
	...
	"gitchat/chat1-web后端实战/project/brokers/backend/module/props/propModel"
...
func HTTPPresentUserProp(c *gin.Context) {
	var req propModel.UserProp
